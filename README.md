...
Скрипт для автоматической настройки обхода DPI, созданный для комфортного стрима Discord или просмотра YouTube.
...
### 💭 [BetterITD](https://github.com/VearyTry/BetterITD/tree/main)
Специальный юзерскрипт чтобы улучшить **[ИТД.com](https://xn--d1ah4a.com)!**
- **Особенности:** Не нужно рисовать баннер вручную, можно выложить; Изменение фона, темы; Скрытие кнопок из меню и профиля и многое другое!
...
- **Экосистема проекта:** Настоящая платформа для сообщества, включающая собственный сайт, Telegram-канал, бота, полноценный форум для обсуждения и самое главное — СОБСТВЕННОЕ ПРИЛОЖЕНИЕ!
